...
var div = L.DomUtil.create('div', 'info2');
	 div.innerHTML +=
	 'VISOR CARTOGRÁFICO<h3>Vulnerabilidad y mortalidad por enfermedades de personas mayores en España';
	 return div;
	};
	title2.addTo(map);
//Logo Matrix	
...
var baseTree = [
	...
	{
	label: '<strong>Modelos espaciales de vulnerabilidad de personas mayores por enfermedades más comunes',
	children: [
	
	    { label: "Modelo espacial de vulnerabilidad según la mortalidad por las 10 enfermedades más comunes",layer: mapa1},
		{ label: "Modelo espacial de vulnerabilidad según la mortalidad por las cuatro enfermedades más comunes",layer: mapa2},
...
{
	label: '<strong>Mapas de mortalidad de personas mayores por las enfermedades más comunes',
	children: [
...
var htmlLegendCURVA10 = L.control.htmllegend({
		position: 'bottomleft',
		legends: [{
			name: "<h2>"+ 'Modelo espacial de vulnerabilidad según la mortalidad por las 10 enfermedades más comunes'+"<\h2>",
			style: styleCURV10,
			layer: curvas10,
			elements: [{
/*return a > 0.500? : '#e11e00' :
	...
	a > 0.100? '#fce9e3' :*/
				...
				label:"<h3>"+  'Tasa de mortalidad específica de personas mayores (≥ 65 años) promedio de este grupo de enfermedades <br>'+"<\h3>",html: '',style: {'background-color': 'write','width': '0px','height': '0px'}}, {
				...
				label: "<h5>" +'<BR><i>Fuente: Elaboración propia con datos provinciales del Instituto Nacional de Estadística (2019)<i><BR>'+"<\h5>",html: '',style: {'background-color': 'write','width': '0px','height': '0px'},																
			}]
		}],
...
var htmlLegendCURVA4 = L.control.htmllegend({
		position: 'bottomleft',
		legends: [{
			name: "<h2>"+ 'Modelo espacial de vulnerabilidad según la mortalidad por las cuatro enfermedades más comunes'+"<\h2>",
			style: styleCURV4,
			layer: curvas4,
			elements: [{
/*return a > 0.500? : '#e11e00' :
...
var htmlLegend8 = L.control.htmllegend({
		position: 'bottomleft',
		legends: [{
			name: "<h2>"+ 'Mortalidad de personas mayores por enfermedades sanguíneas. Promedio del periodo 2007-2018'+"<\h2>",
			style: style8,
			layer: geojson8,
	        elements: [{
...
// L.control.layers(baseLayers, overlays,{collapsed:true, position: 'topright',}).addTo(map);
 ...
 L.control.layers.tree(baseTree, overlayTree).addTo(map).collapseTree();
